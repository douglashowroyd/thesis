...
\begin{lemma}[\cite{fraser-howroyd2}]
...
\newpage
\begin{theorem}[\cite{fraser-howroyd2}]\label{ch-upper-reg:weaktangents}
...
\begin{theorem}[\cite{fraser-howroyd2}]\label{ch-upper-reg:sequences}
	Let $\mu$ be as above.
	\begin{enumerate}
